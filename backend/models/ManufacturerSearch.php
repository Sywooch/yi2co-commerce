...
class ManufacturerSearch extends Manufacturer
{
    ...
    public function rules()
    {
        return [
            ...
            [['manufacturer_name', 'manufacturer_address', 'manufacturer_telephone'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'manufacturer_name', $this->manufacturer_name])
            ->andFilterWhere(['like', 'manufacturer_address', $this->manufacturer_address])
            ->andFilterWhere(['like', 'manufacturer_telephone', $this->manufacturer_telephone]);
