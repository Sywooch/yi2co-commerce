                                ...
                                <!-- <ul class="products">
                                    <li class="product">
                                        <a href="single-product.html">
                                            ...
                                            <span class="price"><span class="amount">Rp <?php echo $data['product_price'] + $opt->product_options_price; ?></span></span>
                                        </a>
                                ...
                                <table cellspacing="0">
                                    <tbody>
                                        <tr class="cart-subtotal">
                                            <th>Cart Subtotal</th>
                                            <td><span class="amount">Rp <?php echo $sum; ?></span></td>
                                        </tr>
                                        ...
                                        <tr class="order-total">
                                            ...
                                            <?php if (isset($discount)) {echo $sum * ((100-$discount->coupon_discount)/100);} else {echo $sum;};?>
                                            </span></strong> </td>
                                        </tr>
                                    </tbody>
                                </table>
